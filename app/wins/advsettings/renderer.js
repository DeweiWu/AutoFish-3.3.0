...
const renderSettings = (config) => {
  ...
  elt(`p`, {className: `settings_header`}, `Window`),
  elt(`div`, {className: `settings_section`},
  ...
  elt('div', {className: "settings_section"},
  wrapInLabel(`Use Log out/Log in:`, renderLogOut(config), `The bot will log out from the game after the given time, wait for a couple of minutes and log back to the game. This functionality might decrease chances of being detected.`),
  ...
  elt(`p`, {className: `settings_header`}, `Reaction Time`),
  elt('div', {className: "settings_section"},
  ...
  elt(`p`, {className: `settings_header settings_header_premium`}, `🐘 Mount Selling`),
  elt('div', {className: "settings_section settings_premium"},
