  ...
  const addButton = elt('input', {type: 'button', className: "spares-addButton", onclick() {
    ...
    this.parentNode.insertBefore(elt('form', {className: "spareContainer"},
      elt(`div`, {className: `spare-inner`, style: ``},
        wrapInLabel(`Description: `, elt('input', { className: "spares-description", value: `Additional Action #${spareNumber++}`,"data-spares": "description"}), `Description.`),
        ...
        wrapInLabel(`Delay After Action (sec):`, elt(`input`, {type: `number`, value: 3, "data-spares": "delay"}), `Delay after action.`),
  ...
  const sparesNodes = spares.map((spare, i) => {
    ...
    return elt('form', {className: "spareContainer"},
      elt(`div`, {className: `spare-inner ${spare.execute ? `spare-execute` : ``}`, style: ``},
        wrapInLabel(`Description: `, elt('input', { className: "spares-description", value: spare.description, "data-spares": "description"}), `Description.`),
...
const renderSettings = (config) => {
  ...
  wrapInLabel("Shut Down Computer After Quitting: ", renderShutDown(config), `The bot will press Left Windows Key and launch command line, after that it will write shutdown -s -t 10 command which will shut down your computer in 10 seconds. `),
    ...
    elt(`p`, {className: `settings_header settings_header_premium`}, `🧙`),elt(`span`, {className: `advanced_settings_header_text`}, `Additional Actions`), elt(`a`, {href: `#`, style: `margin-left: 3px`, onclick: () => {shell.openExternal("https://github.com/jsbots/AutoFish#applying-lures-pushpin")}}, `(Guide)`),
    ...
    elt(`p`, {className: `settings_header settings_header_premium`}, `🔭`),elt(`span`, {className: `advanced_settings_header_text`}, `Players Check`), elt(`a`, {href: `#`, style: `margin-left: 3px`, onclick: () => {shell.openExternal("https://github.com/jsbots/AutoFish#applying-lures-pushpin")}}, `(Guide)`),
    elt(`div`, {className: `settings_section settings_premium`},
