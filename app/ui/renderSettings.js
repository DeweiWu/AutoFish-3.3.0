...
elt('div', {className: `settings_row_wrap`},
    ...
    elt(
      ...
      !config.soundDetection ? wrapInLabel("Feather: ", renderColorSwitch(config), `Bobber color. The color the bot will search within Fishing Zone (${config.bobberColor}, in your case). If the water and environment is bluish, choose red color. If the water and environment is reddish, choose blue color. If nothing helps and the bot still can't find the bobber: choose Manual color and pick color of your bobber.\n\nYour camera position and lighting could play a significant role as well: try different angles and places.`, `thLabel colorLabel`) : ``,
